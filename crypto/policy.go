//go:generate mockgen -destination=mocks/mock_signature_policy.go -package=mocks github.com/evanesco-labs/flow/crypto SignaturePolicy
//go:generate mockgen -destination=mocks/mock_hash_policy.go -package=mocks github.com/evanesco-labs/flow/crypto HashPolicy
